...
public class LimitedServiceFactory {
    ...
    public static Object fallback(Map<Class<?>, Object> registrationMap, LimitedService limitedService, Class<?>[] parameterTypes, Object[] parameter) throws LimitException {
        return FallbackFactoryExecution.fallback(registrationMap, limitedService.fallbackClass(), limitedService.fallbackMethod(), parameterTypes, parameter);
    }
}
