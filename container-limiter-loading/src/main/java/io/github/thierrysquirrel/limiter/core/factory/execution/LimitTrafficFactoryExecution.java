...
public class LimitTrafficFactoryExecution {
    ...
    public static Object limitTraffic(Map<Class<?>, Object> registrationMap, Callable<?> point, LimitTraffic limitTraffic, Class<?>[] parameterTypes, Object[] parameter) throws LimitException {
        ...
        return LimitTrafficFactory.fallback(registrationMap, limitTraffic, parameterTypes, parameter);
    }
}
